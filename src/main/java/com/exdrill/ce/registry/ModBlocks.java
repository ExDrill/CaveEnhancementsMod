...
public class ModBlocks {
    ...
    public static final SlabBlock POLISHED_ROSE_QUARTZ_SLAB = new SlabBlock(FabricBlockSettings.of(Material.STONE).strength(1F, 10).requiresTool().mapColor(MapColor.PINK).sounds(BlockSoundGroup.CALCITE));
    public static final StairsBlock POLISHED_ROSE_QUARTZ_STAIRS = new StairsBlock(POLISHED_ROSE_QUARTZ.getDefaultState(), FabricBlockSettings.of(Material.STONE).strength(1F, 10).requiresTool().mapColor(MapColor.PINK).sounds(BlockSoundGroup.CALCITE).nonOpaque());
